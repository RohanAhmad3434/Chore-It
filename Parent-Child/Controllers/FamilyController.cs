...
//    //// ✅ Add a child user under parent
//    //[HttpPost("{parentId}/add-child")]
//    //public async Task<IActionResult> AddChild(int parentId, [FromBody] User child)
//    //{
//    //    var result = await _service.AddChildAsync(parentId, child);
//    //    return Ok(result);
//    //}

//    [HttpPost("{parentId}/add-child")]
//    public async Task<IActionResult> AddChild(int parentId, [FromBody] ChildRegistrationDto childDto)
//    {
//        // Map DTO to User
//        var child = new User
//        {
...
//            PasswordHash = childDto.Password // hash later in service
//        };
